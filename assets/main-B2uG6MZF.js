import{ab as c,aa as e,a9 as ne,ae as q,a8 as Ot,ac as Be,a2 as T,a7 as ve,f as Jt,a1 as ee,s as De,O as Ue,R as Qt,a as es,V as mt,Q as ft,M as Me,X as Te,u as ts,t as ss,I as ns,g as pt,m as at,n as Pe,a5 as as,B as ot,U as It,z as rs,a0 as xt,$ as gt,r as os,a3 as Le,L as is,q as ls,p as Ae,c as cs,a4 as ds,k as us,o as bt,D as hs,h as ms,A as fs,C as zt,ad as ps,Z as xs,b as vt,x as yt,_ as gs,j as bs,H as vs,y as ys,w as je,S as ws,E as js,a6 as Ns,Y as Dt,d as Ss,G as Ut,P as Es,l as _s,T as Ms,W as wt,F as Ts,K as Ps,e as As,N as Ls,i as Cs,v as Rs}from"./index-su7-xu3Q.js";const jt=["> SYSTEM: TACTICAL_OS_V2.4","> STATUS: ONLINE","> USER: YUEHAN","> ACCESS: GRANTED"],Nt="ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789@#$%^&*",ks=({onComplete:r})=>{const[s,n]=c.useState("scramble"),[t,a]=c.useState(["","","",""]);return c.useEffect(()=>{let i;return s==="scramble"?(i=setInterval(()=>{a(jt.map(d=>d.split("").map(l=>l===" "?" ":Nt[Math.floor(Math.random()*Nt.length)]).join("")))},50),setTimeout(()=>n("resolve"),1500)):s==="resolve"?(a(jt),setTimeout(()=>n("flash"),1e3)):s==="flash"&&setTimeout(r,500),()=>clearInterval(i)},[s,r]),s==="flash"?e.jsx("div",{className:"fixed inset-0 z-[100] bg-white animate-crt-flash pointer-events-none"}):e.jsx("div",{className:"fixed inset-0 z-[100] bg-[#010208] flex items-center justify-center font-mono p-8",children:e.jsx("div",{className:"max-w-2xl w-full",children:t.map((i,d)=>e.jsx("div",{className:`text-xl md:text-2xl tracking-widest font-black mb-2 ${s==="scramble"?"text-emerald-500":"text-cyan-400"}`,children:i},d))})})};/**
